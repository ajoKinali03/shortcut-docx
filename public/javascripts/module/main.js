let pageLocationHome = window.location.href;
...
if(pageLocationHome == "http://localhost:3000/home"){
...
const persetujuanPrivasi = (value) => {
  ...
  if (value) {
    ...
    let setuju = confirm(
      'Apakah sudah membaca Kebijakan Privasi kami?\n\n Jika sudah silahkan tekan "OKE" untuk setuju dengan kebijakan privasi kami'
    ).valueOf();
